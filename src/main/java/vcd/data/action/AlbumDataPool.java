...
public class AlbumDataPool {
	...
	private void createPool() {
		String line;
		try {
			br = new BufferedReader(new FileReader(".\\db\\music.db"));
			while((line = br.readLine()) != null) {
				
				String[] arrAlbum = new String[5];
				arrAlbum = line.split(",");
				
				int n = 0;
				
				int locate = Integer.valueOf(arrAlbum[4].trim());
				
				String[][] arrMusic = new String[locate][];
				...
				while((line = br.readLine()) != null) {
					...
					arrMusic[n] = line.split(",");
					n++;
				}
				
				poolAdd(arrAlbum, arrMusic);
			}
